...
- Producer.py - продюсер, который отправляет 5 сообщений в топик Kafka с использованием схемы JSON (приложена в файле production-topic-value.json)
- Consumer.py - консьюмер, просто вычитывающий сообщения в составе группы prod_consumer_group
- Hadoop.py - консьюмер, вычитывающий сообщения в составе группы hadoop_consumer_group и записывающий сообщения в отдельные файлы в HDFS
